...
class NiceApiService
{
    ...
    private const NICE_CODE_MESSAGES = [
        // 5000 = "대상기관 장애로 조회가 원활하지 않습니다" (2026-06-24 jin 실측). 원천기관 다운.
        '5000' => 'NICE 가 조회하는 원천기관(자동차 등록정보 제공기관)에 일시 장애가 있습니다. 기관 복구 후 다시 시도해 주세요 (NICE·시스템 문제 아님)',
    ];
    ...
    public static function humanizeError(string $raw, ?int $status = null): string
    {
        ...
        // ③ 대상기관 장애 — NICE 가 조회하는 원천기관(자동차 등록정보 제공기관)이 다운. NICE·우리 문제 아님.
        if (preg_match('/대상기관|원천기관|기관\s*장애|원활하지\s*않/u', $raw)) {
            return 'NICE 가 조회하는 원천기관(자동차 등록정보 제공기관)에 일시 장애가 있습니다. NICE·시스템 문제가 아니며, 기관 복구 후 다시 시도해 주세요. (급하면 수기 입력 / NICE 고객센터 1588-5659)';
        }
