...
>
> ✅ **3사 배포 완료** (master `c25f0bb`, 2026-09-12 · 잡 5개 green · 3사 302 · 마이그 1건 적용).
> 🅿️ 남은 것 = Notion 발행(Codex 몫).
>
> 📏 **배포 후 운영 실측 — 아래 §1-7 의 예측과 다르다. 이 숫자가 권위다.**
>
> | 회사 | 「예외 대상」 전체 | 그중 「운임비와 동일」 |
> |---|---|---|
> | heymanerp | 60대 | **6대** (§1-7 예측과 일치) |
> | ssancarerp | 710대 | **19대** ← §1-7 은 「0건」이라고 적었다 |
> | karabaerp | 122대 | **1대** (§1-7 미실측) |
>
> 🚨 **§1-7 의 「ssancarerp 운임비 일치 0건」은 틀렸다.** 그때는 「미수 > 0 인 458건」만 셌는데,
>    실제 대상은 **운임 미확정만 걸린 차**까지 포함해 710대이고 그중 19대가 운임비와 일치한다.
>    ⇒ **「전부 진짜 미수라 누를 일이 없다」는 전제를 쓰지 말 것.** 뱃지를 보고 판단한다.
>
