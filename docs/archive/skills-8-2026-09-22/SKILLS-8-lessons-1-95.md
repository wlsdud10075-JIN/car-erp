# SKILLS §8 아카이브 — 버그·교훈 #1 ~ #95 (2026-05 ~ 2026-09-12)

> 2026-09-22 트림. `SKILLS.md` 가 295KB(§8 만 2,400줄)라 매 세션 컨텍스트를 채워서, **#96 이후만 본문에 남기고 #1~#95 전문을 여기로** 옮겼다.
> 내용은 한 글자도 안 고쳤다(번호·소제목 그대로). `SKILLS.md §8` 상단의 색인표에서 번호·키워드를 고른 뒤 여기서 읽는다.
> 찾는 법: `grep -n "^### 47\." docs/archive/skills-8-2026-09-22/SKILLS-8-lessons-1-95.md` 또는 키워드 grep.
> ⚠️ CLAUDE.md·MEMORY·코드 주석의 「§8 #N」 참조는 전부 이 파일의 같은 번호를 가리킨다.
