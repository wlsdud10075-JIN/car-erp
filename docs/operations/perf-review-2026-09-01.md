...
**한 줄 결론**: 원본 문서에서 가장 크게 먹힐 것은 **압축**인데 ERP는 그걸 **안 하고 있다.**
그리고 jin이 걱정한 **데이터량은 아직 병목이 아니다** — 검색 경로만 미리 손볼 값어치가 있다.
...
heymanerp   52.79.200.151    차량   264대   ← 실사용 트래픽이 있는 쪽 (로그 측정)
...
## 6. 🔵 5순위 — 데이터량: **지금은 병목이 아니다. 검색만 예외다.**
