...
## 참조 문서 (필요 시 Read)
- `C:/xampp/htdocs/car-erp/CLAUDE.md` — 환경(Laravel 12, Volt, Tailwind v4), 권한, 차량 11단계 computed, 정산 공식, 핵심 주의사항 11개
...
- **11단계 변경**: `progress_status_cache` 동기화 + 우선순위 평가 + bulk 변경 시 `php artisan vehicles:rebuild-progress-cache`
