...
return [
    ...
    // Settlement gate override (jin 2026-09-12)
    'gate' => [
        ...
        'candidates_desc' => 'Vehicles with no settlement yet whose only blockers can be waived with a reason. Created exactly like the automatic path (attribution month = full-payment month).',
        'candidates_empty' => 'No vehicle can be overridden.',
        'candidates_count' => ':count vehicle(s)',
        'col_vehicle' => 'Vehicle',
        'col_salesman' => 'Salesperson',
        'col_unpaid' => 'Unpaid',
        'col_freight' => 'Freight',
        'col_reasons' => 'Blockers',
        'same_as_freight' => 'Same as freight',
        'create_btn' => 'Create with override',
        'apply_btn' => 'Override',
        'release_btn' => 'Release override',
        'confirm_release' => 'Releasing puts the payout back on hold from the next batch and restores the ledger lock immediately. Payouts already made are not reversed. Release?',
        'reason_title' => 'Override reason',
        'reason_desc' => 'Write at least :min characters explaining what is being waived and why. This is kept in the audit log.',
        'reason_ph' => 'e.g. Unpaid 1,312 EUR equals the freight fee, which is outside the settlement base. Will settle on arrival.',
        'reason_submit' => 'Override',
        'reason_required' => 'This vehicle cannot be settled because of :reasons. To proceed anyway, write an override reason of at least :min characters.',
        'not_overridable' => 'This vehicle cannot be settled because of :reasons. That is an input problem, not something a reason can waive.',
        'done' => 'Override applied.',
        'released' => 'Override released.',
        'panel_title' => 'Why this cannot be settled',
        'panel_overridable' => 'Write a reason and it can be created as is. Such a settlement also passes the payout hold and the full-payment condition of the secondary close.',
        'panel_blocked' => 'This is an input problem (salesperson, sale price, duplicate settlement) — fix the input instead.',
        'warn_fx' => 'Closing the secondary settlement locks the FX difference and carryover. Money received afterwards is not reflected in the salesperson payout. (Entering a later balance at the sale rate leaves the settlement figures unchanged.)',
        'blocker' => [
            'purchase_cancelled' => 'Purchase cancelled',
            'no_sale' => 'No sale price',
            'unpaid' => 'Receivable remaining',
            'no_salesman' => 'No salesperson',
            'already_exists' => 'Settlement already exists',
            'freight_unconfirmed' => 'Freight not confirmed',
            'domestic_zero' => 'Domestic margin is zero',
        ],
    ],
