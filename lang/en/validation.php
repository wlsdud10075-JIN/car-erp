...
return [
    ...
    */
    ...
    'attributes' => [
        // 핵심 도메인 컬럼 (영어모드 라벨 — ko는 config/column_labels.php)
        ...
        'token' => 'token',
        // 양식 컴포넌트(Livewire 프로퍼티)
        'costImportFile' => 'statement file',
        'photoUpload' => 'attachment',
        'photoUpload.*' => 'attachment',
        'qaName' => 'name',
        'qaCountryId' => 'country',
        'qaSalesmanId' => 'salesman',
        'overrideStage' => 'stage',
        'overrideReason' => 'reason',
        'ledgerUnlockReason' => 'unlock reason',
        'salesman_id_str' => 'salesman',
        'cons_name' => 'consignee name',
        'cons_id_type' => 'ID type',
        'cons_id_value' => 'ID number',
        'txn_amount' => 'amount',
        'blForm.bl_type' => 'B/L type',
