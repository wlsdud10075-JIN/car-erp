...
return [
    ...
    'action' => [
        ...
        'entry_locked_tip_aggregate' => '묶음 총 입금률이 필요 :req% 에 못 미칩니다 (미수율 :pct%) — 입금 늘리거나 미달 차 빼고 재묶음',
        'done' => '완료 처리',
        'cancel' => '취소',
        'more' => '더보기',
    ...
    'toast' => [
        ...
        'decl_applied' => '묶음 :count대에 일괄 기입했습니다.',
    ...
    'lock' => [
        ...
        'entry_blocked_aggregate' => '선적 착수 불가 — 묶음 총 입금률이 필요 :req% 에 못 미칩니다 (미수율 :pct%). 입금을 늘리거나 미달 차량을 빼고 다시 묶으세요.',
    ],

    // 수출신고번호 일괄 기입 (묶음 공유 1개 → 전체)
    'decl' => [
        'enter' => '수출신고번호·컨테이너 기입',
        'title' => '수출신고번호·컨테이너 번호 — 묶음 :n대 일괄 기입',
        'field_number' => '수출신고번호',
        'field_container' => '컨테이너 번호',
        'placeholder' => '예: 12345-67-890123X',
        'container_placeholder' => '예: TEMU1234567',
        'hint' => '묶인 차량 전체에 같은 값이 기입됩니다. 입력한 칸만 반영되고, 빈 칸은 기존 값을 그대로 둡니다.',
        'apply' => '일괄 기입',
        'cancel' => '닫기',
        'invalid' => '수출신고번호 또는 컨테이너 번호를 입력하세요.',
    ],
