...
return [
    ...
    'action' => [
        ...
        'entry_locked_tip_aggregate' => '묶음 총 입금률이 50% 미만입니다 (미수율 :pct%) — 입금 늘리거나 미달 차 빼고 재묶음',
        'done' => '완료 처리',
        'cancel' => '취소',
        'more' => '더보기',
    ...
    'lock' => [
        ...
        'entry_blocked_aggregate' => '선적 착수 불가 — 묶음 총 입금률이 50% 미만입니다 (미수율 :pct%). 입금을 늘리거나 미달 차량을 빼고 다시 묶으세요.',
    ],
