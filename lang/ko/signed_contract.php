...
return [
    ...
    'notify' => [
        ...
        'revoked' => '전자서명 요청을 무르고 링크를 무효화했습니다.',
    ],
    'revoke' => [
        'btn' => '무르기',
        'title' => '전자서명 요청 무르기 — 바이어에게 보낸 링크가 즉시 무효화됩니다',
        'confirm' => '전자서명 요청을 무르시겠습니까?\n\n바이어에게 보낸 링크가 즉시 무효가 되어 서명할 수 없게 됩니다.\n(이미 서명이 끝난 계약은 무를 수 없습니다.)',
        'signed_locked' => '이미 서명이 완료된 계약은 무를 수 없습니다. (법적 증거물)',
        'not_active' => '이미 무름 처리되었거나 만료된 요청입니다.',
    ],
    'issue' => [
        'empty' => '차량을 선택하세요.',
