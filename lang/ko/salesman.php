...
return [
    ...
    'field' => [
        ...
        // 🚪 2026-09-16 jin — 「헤이맨」처럼 사람이 아닌 계정(자매 회사)용.
        'money_ph' => '미입력',
        'deposit' => '예치금 (보유액)',
        'deposit_hint' => '이 프리랜서가 맡겨둔 예치금 잔액입니다. 표시 전용이라 월 지급액에 더해지지 않습니다. 반환·추가 입금이 있는 달은 월배치 제출 모달에서 조정 줄로 넣으세요.',
        'base_salary' => '기본급 (월)',
        'base_salary_hint' => '이 사내직원의 월 기본급입니다. 표시 전용이라 배치 총액·회사이익에 들어가지 않고, 월배치 화면에 「기본급 + 정산 = 월수령액」으로만 보입니다.',
        'payout_excluded' => '정산 지급 대상 아님',
        'payout_excluded_hint' => '사람이 아닌 계정(자매 회사 등)에 켭니다. 켜면 이 담당자의 정산은 확정해도 월배치에 들어가지 않아 0원 줄이 쌓이지 않습니다. 정산 자체는 그대로 만들어지고 목록에서 보이며, 이미 지급이 끝난 건은 소급해서 빠지지 않습니다.',
    ...
    'handover' => [
        ...
        'pick' => '넘길 바이어',
        'picked' => ':total명 중 :n명 선택',
        'all' => '전체 선택',
        'none' => '전체 해제',
        'n_vehicles' => '진행중 :n대',
        'no_buyers' => '넘길 바이어가 없습니다.',
        'follows' => '고른 바이어의 진행중 차량이 함께 넘어갑니다.',
        'skip' => [
            'has_settlement' => '정산으로 빠진 차량 :n대 — 원 담당자가 그대로 정산받습니다',
            'buyer_not_selected' => '안 고른 바이어의 차량 :n대 — 그 바이어를 넘길 때 같이 갑니다',
            'no_buyer' => '담당 바이어가 없는 차량 :n대 — 바이어 목록 「담당자 미지정」에서 담당자를 먼저 지정하세요',
        ],
        'moving' => '넘어가는 것',
        'skipping' => '그대로 두는 것',
        'buyers' => '바이어 :n명',
