...
return [
    ...
    'payout_excluded' => [
        'badge' => '지급 대상 아님',
        'tooltip' => '담당자 「:name」이 지급 대상에서 제외돼 있어 월배치에 들어가지 않습니다. 영업담당자 설정에서 바꿀 수 있습니다.',
    ],
    'held' => [
        'badge' => '미수 지급보류',
        'filter' => '지급보류만',
    ...
    'gate' => [
        ...
        'candidates_desc' => '정산이 아직 안 만들어진 차량 중, 사유만 쓰면 통과시킬 수 있는 것만 보입니다. 만들면 자동 생성과 똑같이(귀속월=완납월) 만들어집니다.',
        ...
        'col_freight' => '운임비',
        'col_reasons' => '막힌 사유',
        'same_as_freight' => '운임비와 동일',
        'create_btn' => '예외로 정산 생성',
        'apply_btn' => '예외 처리',
        'release_btn' => '예외 해제',
        'confirm_release' => '예외를 해제하면 다음 배치부터 다시 지급보류되고 회계 잠금도 즉시 돌아옵니다. 이미 지급된 것은 되돌아오지 않습니다. 해제할까요?',
        'reason_title' => '예외 사유',
        'reason_desc' => '무엇을 왜 넘기는지 :min자 이상 적어주세요. 이 사유는 감사 기록에 남습니다.',
        'reason_ph' => '예) 미수 1,312 EUR — 운임비와 같은 금액이라 정산 숫자에 영향 없음. 도착 후 정산 예정.',
        'reason_submit' => '예외로 처리',
        'reason_required' => '이 차량은 :reasons 때문에 정산을 만들 수 없습니다. 그래도 만들려면 예외 사유를 :min자 이상 적어주세요.',
        'not_overridable' => '이 차량은 :reasons 때문에 정산을 만들 수 없습니다. 이건 사유로 넘기는 게 아니라 입력을 고쳐야 합니다.',
        'done' => '예외로 처리했습니다.',
        'released' => '예외를 해제했습니다.',
        'panel_title' => '정산을 만들 수 없는 사유',
        'panel_overridable' => '사유를 적으면 이대로 만들 수 있습니다. 만든 정산은 지급보류도, 2차 마감의 완납 조건도 통과합니다.',
        'panel_blocked' => '이건 사유로 넘기는 게 아니라 입력을 고쳐야 합니다(담당자·판매가·중복 정산 등).',
        'warn_fx' => '2차 마감하는 순간 환차·이월이 확정됩니다. 그 뒤에 들어온 돈은 담당자 정산에 반영되지 않습니다. (나중 잔금을 판매환율로 넣으면 정산 숫자는 안 움직입니다.)',
        'blocker' => [
            'purchase_cancelled' => '매입취소 차량',
            'no_sale' => '판매가 없음',
            'unpaid' => '미수 남음',
            'no_salesman' => '담당자 없음',
            'already_exists' => '이미 정산 있음',
            'freight_unconfirmed' => '운임 미확정',
            'domestic_zero' => '내수 차액 0',
        ],
    ],
    ...
    'domestic' => [
        ...
        'purchase_price' => '매입가',
        'base' => '내수 기준액',
        'note' => '내수는 부가세 계산이 없습니다 — 총판매가에서 매입가·말소비·탁송비만 뺍니다. 면허비·캐리비 등 나머지 비용은 내수 계산에 들어가지 않습니다.',
    ],
];
