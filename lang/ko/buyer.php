...
return [
    ...
    'receivable' => [
        ...
        'deposit_title' => '보증금 여력',
        'deposit_used_limit' => '사용중 보증금 ₩:used · 한도 ₩:limit',
        'deposit_note' => '여력을 다 쓰면(선적 전 미수 :pct% 초과) 신규 차량 등록이 제한됩니다.',
        'deposit_note_full' => '⚠ 보증금 여력 소진 — 신규 차량 등록 제한 (관리 승인 시 가능).',
    ],
    'fees' => [
