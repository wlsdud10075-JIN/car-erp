...
return [
    ...
    'kpi' => [
        ...
        'settlement' => [
            ...
            'cancel' => ['l' => '매입취소', 'h' => '취소완료·미수 취소건 전체 (채권관리 취소필터에서 상세)'],
        ],
        'management' => [
    ...
    'act' => [
        'sales' => [
            ...
            'cancel_unpaid' => ['l' => '매입취소', 'd' => '취소완료·미수 취소건 (클릭 시 채권관리)'],
        ],
        'clearance' => [
            'deregistration_needed' => ['l' => '말소 처리 필요', 'd' => '매입 완료 → 말소 미처리'],
            'clearance_request_needed' => ['l' => '통관 신청 필요', 'd' => '판매 완납 → 면장 미업로드'],
            'clearance_info_missing' => ['l' => '통관 바이어/일자 누락', 'd' => '판매 진입 → 통관 바이어 또는 선적일 없음'],
        ...
        'settlement' => [
            ...
            'freight_confirm' => ['l' => '인코텀즈 확정 필요', 'd' => '완납했으나 인코텀즈(FOB/CFR)·운임비 미확정 → 정산 대기'],
            'secondary_close' => ['l' => '2차 정산 마감 대기', 'd' => '지급(paid) 후 2차 정산 미마감 → 비용·환차 정정 후 마감'],
            'receivable_risk' => ['l' => '채권 위험', 'd' => '회수 위험·심각 등급'],
            'cancel_unpaid' => ['l' => '매입취소', 'd' => '취소완료·미수 취소건 (미수는 마감/손실 처리)'],
        ],
        'management' => [
