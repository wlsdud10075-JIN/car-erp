 ...
 * 🚨 **이 값은 LibreOffice 기준이다 — 엑셀은 같은 열을 ~9% 좁게 그린다**(2026-09-16 실측:
 *    같은 파일의 내용 폭이 엑셀 90% ↔ LibreOffice 99%). 즉 **늘릴 여유가 엑셀 쪽에서 그만큼 적다.**
 *    LibreOffice 로만 확인하고 키우면 **jin 이 보는 엑셀에서만 잘린다.**
 *    `WIDTH_SCALE` 로 함께 곱하는 한 이 비는 보존되므로, 배율만 바꾸는 건 안전하다.
 */
const CLAUSE_PT = 6.0;
const CLAUSE_LH = 9.2;
